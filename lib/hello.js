...
function populateDb() {
  ...
  var singleChampUrl = function(name) {
    return 'http://ddragon.leagueoflegends.com/cdn/5.2.1/data/en_US/champion/'+formatter(name)+'.json';
  };
  var thumbnailUrl = function(name) {
    return 'http://ddragon.leagueoflegends.com/cdn/5.2.1/img/champion/'+formatter(name)+'.png';
  };
  var splashUrl = function(name) {
    return 'http://ddragon.leagueoflegends.com/cdn/img/champion/splash/'+formatter(name)+'_0.jpg';
  };
