...
function populateChamps() {
  ...
  var singleChampUrl = function(name) { return 'http://ddragon.leagueoflegends.com/cdn/5.2.1/data/en_US/champion/'+formatter.forApi(name)+'.json'; };
  var thumbnailUrl   = function(name) { return 'http://ddragon.leagueoflegends.com/cdn/5.2.1/img/champion/'+formatter.forApi(name)+'.png'; };
  var splashUrl      = function(name) { return 'http://ddragon.leagueoflegends.com/cdn/img/champion/splash/'+formatter.forApi(name)+'_0.jpg'; };
